...
parser = argparse.ArgumentParser(description='Simple attack roller for D&D 5th edition.')
...
parser.add_argument('-c', help='number of times to repeat the attack', type = int)
